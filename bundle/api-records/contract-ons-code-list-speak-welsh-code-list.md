---
type: "Contract"
title: "ONS code list: speak-welsh contract"
description: "Machine-readable or service-description contract inferred for ONS code list: speak-welsh from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/speak-welsh"
timestamp: ""
...
# ONS code list: speak-welsh contract

Machine-readable or service-description contract inferred for ONS code list: speak-welsh from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/speak-welsh
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/speak-welsh
