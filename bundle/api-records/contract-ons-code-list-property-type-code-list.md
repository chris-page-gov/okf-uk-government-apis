---
type: "Contract"
title: "ONS code list: property-type contract"
description: "Machine-readable or service-description contract inferred for ONS code list: property-type from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/property-type"
timestamp: ""
...
# ONS code list: property-type contract

Machine-readable or service-description contract inferred for ONS code list: property-type from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/property-type
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/property-type
