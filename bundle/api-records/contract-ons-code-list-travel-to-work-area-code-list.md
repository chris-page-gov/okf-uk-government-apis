---
type: "Contract"
title: "ONS code list: travel-to-work-area contract"
description: "Machine-readable or service-description contract inferred for ONS code list: travel-to-work-area from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/travel-to-work-area"
timestamp: ""
...
# ONS code list: travel-to-work-area contract

Machine-readable or service-description contract inferred for ONS code list: travel-to-work-area from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/travel-to-work-area
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/travel-to-work-area
