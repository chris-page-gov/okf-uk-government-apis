---
type: "Contract"
title: "ONS code list: dd-mm contract"
description: "Machine-readable or service-description contract inferred for ONS code list: dd-mm from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/dd-mm"
timestamp: ""
...
# ONS code list: dd-mm contract

Machine-readable or service-description contract inferred for ONS code list: dd-mm from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/dd-mm
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/dd-mm
