---
type: "Contract"
title: "ONS code list: cdid contract"
description: "Machine-readable or service-description contract inferred for ONS code list: cdid from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/cdid"
timestamp: ""
...
# ONS code list: cdid contract

Machine-readable or service-description contract inferred for ONS code list: cdid from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/cdid
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/cdid
