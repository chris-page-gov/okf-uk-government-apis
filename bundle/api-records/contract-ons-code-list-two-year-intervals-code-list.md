---
type: "Contract"
title: "ONS code list: two-year-intervals contract"
description: "Machine-readable or service-description contract inferred for ONS code list: two-year-intervals from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/two-year-intervals"
timestamp: ""
...
# ONS code list: two-year-intervals contract

Machine-readable or service-description contract inferred for ONS code list: two-year-intervals from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/two-year-intervals
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/two-year-intervals
