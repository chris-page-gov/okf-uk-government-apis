---
type: "API Operation"
title: "ONS Beta API: List code lists"
description: "Template operation for the ONS Beta API: List code lists."
...
# ONS Beta API: List code lists

Template operation for the ONS Beta API: List code lists.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists
