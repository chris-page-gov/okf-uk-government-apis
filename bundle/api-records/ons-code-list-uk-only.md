---
type: "Schema"
title: "ONS code list: uk-only"
description: "Code list exposed by the ONS Beta API: uk-only."
...
# ONS code list: uk-only

Code list exposed by the ONS Beta API: uk-only.
