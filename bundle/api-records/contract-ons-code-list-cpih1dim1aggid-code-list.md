---
type: "Contract"
title: "ONS code list: cpih1dim1aggid contract"
description: "Machine-readable or service-description contract inferred for ONS code list: cpih1dim1aggid from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/cpih1dim1aggid"
timestamp: ""
...
# ONS code list: cpih1dim1aggid contract

Machine-readable or service-description contract inferred for ONS code list: cpih1dim1aggid from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/cpih1dim1aggid
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/cpih1dim1aggid
