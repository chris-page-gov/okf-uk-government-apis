...
title: "OpenDataCommunities (Official statistics from MHCLG) SPARQL endpoint contract"
description: "Machine-readable or service-description contract inferred for OpenDataCommunities (Official statistics from MHCLG) SPARQL endpoint from public metadata."
resource: "https://opendatacommunities.org/help"
...
# OpenDataCommunities (Official statistics from MHCLG) SPARQL endpoint contract

Machine-readable or service-description contract inferred for OpenDataCommunities (Official statistics from MHCLG) SPARQL endpoint from public metadata.
...
- Endpoint: https://opendatacommunities.org/help
