---
type: "Contract"
title: "ONS code list: age-groups contract"
description: "Machine-readable or service-description contract inferred for ONS code list: age-groups from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/age-groups"
timestamp: ""
...
# ONS code list: age-groups contract

Machine-readable or service-description contract inferred for ONS code list: age-groups from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/age-groups
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/age-groups
