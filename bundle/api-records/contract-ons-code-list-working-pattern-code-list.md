---
type: "Contract"
title: "ONS code list: working-pattern contract"
description: "Machine-readable or service-description contract inferred for ONS code list: working-pattern from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/working-pattern"
timestamp: ""
...
# ONS code list: working-pattern contract

Machine-readable or service-description contract inferred for ONS code list: working-pattern from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/working-pattern
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/working-pattern
