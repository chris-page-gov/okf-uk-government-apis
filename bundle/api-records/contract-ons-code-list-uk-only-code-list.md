---
type: "Contract"
title: "ONS code list: uk-only contract"
description: "Machine-readable or service-description contract inferred for ONS code list: uk-only from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/uk-only"
timestamp: ""
...
# ONS code list: uk-only contract

Machine-readable or service-description contract inferred for ONS code list: uk-only from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/uk-only
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/uk-only
