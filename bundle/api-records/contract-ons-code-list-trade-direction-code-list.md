---
type: "Contract"
title: "ONS code list: trade-direction contract"
description: "Machine-readable or service-description contract inferred for ONS code list: trade-direction from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/trade-direction"
timestamp: ""
...
# ONS code list: trade-direction contract

Machine-readable or service-description contract inferred for ONS code list: trade-direction from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/trade-direction
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/trade-direction
