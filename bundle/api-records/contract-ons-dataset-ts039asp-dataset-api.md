...
# Provision of unpaid care, age-standardised proportions contract

Machine-readable or service-description contract inferred for Provision of unpaid care, age-standardised proportions from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/TS039ASP
- Documentation: https://api.beta.ons.gov.uk/v1/datasets/TS039ASP
