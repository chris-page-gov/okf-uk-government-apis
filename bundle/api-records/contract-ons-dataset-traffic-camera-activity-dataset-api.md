...
# Traffic Camera Activity contract

Machine-readable or service-description contract inferred for Traffic Camera Activity from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/traffic-camera-activity
- Documentation: https://api.beta.ons.gov.uk/v1/datasets/traffic-camera-activity
