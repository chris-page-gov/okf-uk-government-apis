---
type: "Schema"
title: "ONS code list: spend-category"
description: "Code list exposed by the ONS Beta API: spend-category."
...
# ONS code list: spend-category

Code list exposed by the ONS Beta API: spend-category.
