---
type: "Contract"
title: "ONS code list: healthcare-provider contract"
description: "Machine-readable or service-description contract inferred for ONS code list: healthcare-provider from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/healthcare-provider"
timestamp: ""
...
# ONS code list: healthcare-provider contract

Machine-readable or service-description contract inferred for ONS code list: healthcare-provider from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/healthcare-provider
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/healthcare-provider
