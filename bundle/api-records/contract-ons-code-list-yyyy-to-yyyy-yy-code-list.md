---
type: "Contract"
title: "ONS code list: yyyy-to-yyyy-yy contract"
description: "Machine-readable or service-description contract inferred for ONS code list: yyyy-to-yyyy-yy from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/yyyy-to-yyyy-yy"
timestamp: ""
...
# ONS code list: yyyy-to-yyyy-yy contract

Machine-readable or service-description contract inferred for ONS code list: yyyy-to-yyyy-yy from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-to-yyyy-yy
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-to-yyyy-yy
