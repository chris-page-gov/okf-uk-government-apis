---
type: "Contract"
title: "ONS code list: shipping-port contract"
description: "Machine-readable or service-description contract inferred for ONS code list: shipping-port from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/shipping-port"
timestamp: ""
...
# ONS code list: shipping-port contract

Machine-readable or service-description contract inferred for ONS code list: shipping-port from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/shipping-port
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/shipping-port
