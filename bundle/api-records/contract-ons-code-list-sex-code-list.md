---
type: "Contract"
title: "ONS code list: sex contract"
description: "Machine-readable or service-description contract inferred for ONS code list: sex from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/sex"
timestamp: ""
...
# ONS code list: sex contract

Machine-readable or service-description contract inferred for ONS code list: sex from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/sex
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/sex
