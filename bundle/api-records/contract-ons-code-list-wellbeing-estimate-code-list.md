---
type: "Contract"
title: "ONS code list: wellbeing-estimate contract"
description: "Machine-readable or service-description contract inferred for ONS code list: wellbeing-estimate from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/wellbeing-estimate"
timestamp: ""
...
# ONS code list: wellbeing-estimate contract

Machine-readable or service-description contract inferred for ONS code list: wellbeing-estimate from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/wellbeing-estimate
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/wellbeing-estimate
