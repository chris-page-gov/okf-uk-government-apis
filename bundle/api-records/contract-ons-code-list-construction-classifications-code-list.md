---
type: "Contract"
title: "ONS code list: construction-classifications contract"
description: "Machine-readable or service-description contract inferred for ONS code list: construction-classifications from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/construction-classifications"
timestamp: ""
...
# ONS code list: construction-classifications contract

Machine-readable or service-description contract inferred for ONS code list: construction-classifications from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/construction-classifications
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/construction-classifications
