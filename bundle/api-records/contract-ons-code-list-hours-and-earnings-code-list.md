---
type: "Contract"
title: "ONS code list: hours-and-earnings contract"
description: "Machine-readable or service-description contract inferred for ONS code list: hours-and-earnings from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/hours-and-earnings"
timestamp: ""
...
# ONS code list: hours-and-earnings contract

Machine-readable or service-description contract inferred for ONS code list: hours-and-earnings from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/hours-and-earnings
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/hours-and-earnings
