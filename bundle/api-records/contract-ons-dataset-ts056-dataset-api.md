...
# Second address indicator contract

Machine-readable or service-description contract inferred for Second address indicator from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/TS056
- Documentation: https://api.beta.ons.gov.uk/v1/datasets/TS056
