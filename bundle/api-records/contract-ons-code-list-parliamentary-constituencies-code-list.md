---
type: "Contract"
title: "ONS code list: parliamentary-constituencies contract"
description: "Machine-readable or service-description contract inferred for ONS code list: parliamentary-constituencies from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/parliamentary-constituencies"
timestamp: ""
...
# ONS code list: parliamentary-constituencies contract

Machine-readable or service-description contract inferred for ONS code list: parliamentary-constituencies from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/parliamentary-constituencies
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/parliamentary-constituencies
