---
type: "Contract"
title: "ONS code list: welsh-household-composition contract"
description: "Machine-readable or service-description contract inferred for ONS code list: welsh-household-composition from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/welsh-household-composition"
timestamp: ""
...
# ONS code list: welsh-household-composition contract

Machine-readable or service-description contract inferred for ONS code list: welsh-household-composition from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/welsh-household-composition
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/welsh-household-composition
