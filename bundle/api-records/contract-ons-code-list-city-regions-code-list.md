---
type: "Contract"
title: "ONS code list: city-regions contract"
description: "Machine-readable or service-description contract inferred for ONS code list: city-regions from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/city-regions"
timestamp: ""
...
# ONS code list: city-regions contract

Machine-readable or service-description contract inferred for ONS code list: city-regions from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/city-regions
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/city-regions
