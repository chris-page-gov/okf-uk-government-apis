---
type: "API Operation"
title: "ONS Beta API: Get dataset"
description: "Template operation for the ONS Beta API: Get dataset."
resource: "https://api.beta.ons.gov.uk/v1/datasets/{dataset_id}"
timestamp: ""
...
# ONS Beta API: Get dataset

Template operation for the ONS Beta API: Get dataset.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/{dataset_id}
