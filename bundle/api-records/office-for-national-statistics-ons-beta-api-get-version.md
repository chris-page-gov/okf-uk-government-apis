...
# ONS Beta API: Get dataset version

Template operation for the ONS Beta API: Get dataset version.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/{dataset_id}/editions/{edition}/versions/{version}
