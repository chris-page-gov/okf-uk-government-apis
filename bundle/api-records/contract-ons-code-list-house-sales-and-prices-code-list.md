---
type: "Contract"
title: "ONS code list: house-sales-and-prices contract"
description: "Machine-readable or service-description contract inferred for ONS code list: house-sales-and-prices from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/house-sales-and-prices"
timestamp: ""
...
# ONS code list: house-sales-and-prices contract

Machine-readable or service-description contract inferred for ONS code list: house-sales-and-prices from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/house-sales-and-prices
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/house-sales-and-prices
