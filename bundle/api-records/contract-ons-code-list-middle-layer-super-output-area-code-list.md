---
type: "Contract"
title: "ONS code list: middle-layer-super-output-area contract"
description: "Machine-readable or service-description contract inferred for ONS code list: middle-layer-super-output-area from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/middle-layer-super-output-area"
timestamp: ""
...
# ONS code list: middle-layer-super-output-area contract

Machine-readable or service-description contract inferred for ONS code list: middle-layer-super-output-area from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/middle-layer-super-output-area
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/middle-layer-super-output-area
