---
type: "Contract"
title: "ONS code list: yyyy-yy contract"
description: "Machine-readable or service-description contract inferred for ONS code list: yyyy-yy from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/yyyy-yy"
timestamp: ""
...
# ONS code list: yyyy-yy contract

Machine-readable or service-description contract inferred for ONS code list: yyyy-yy from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-yy
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-yy
