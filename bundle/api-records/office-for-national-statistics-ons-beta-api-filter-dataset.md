---
type: "API Operation"
title: "ONS Beta API: Filter a dataset"
description: "Template operation for the ONS Beta API: Filter a dataset."
resource: "https://api.beta.ons.gov.uk/v1/filters"
timestamp: ""
...
# ONS Beta API: Filter a dataset

Template operation for the ONS Beta API: Filter a dataset.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/filters
