---
type: "Contract"
title: "ONS code list: quintile contract"
description: "Machine-readable or service-description contract inferred for ONS code list: quintile from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/quintile"
timestamp: ""
...
# ONS code list: quintile contract

Machine-readable or service-description contract inferred for ONS code list: quintile from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/quintile
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/quintile
