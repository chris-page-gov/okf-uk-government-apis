---
type: "Contract"
title: "ONS code list: income-type contract"
description: "Machine-readable or service-description contract inferred for ONS code list: income-type from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/income-type"
timestamp: ""
...
# ONS code list: income-type contract

Machine-readable or service-description contract inferred for ONS code list: income-type from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/income-type
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/income-type
