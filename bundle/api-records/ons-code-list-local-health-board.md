---
type: "Schema"
title: "ONS code list: local-health-board"
description: "Code list exposed by the ONS Beta API: local-health-board."
...
# ONS code list: local-health-board

Code list exposed by the ONS Beta API: local-health-board.
