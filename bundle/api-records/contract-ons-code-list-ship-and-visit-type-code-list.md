---
type: "Contract"
title: "ONS code list: ship-and-visit-type contract"
description: "Machine-readable or service-description contract inferred for ONS code list: ship-and-visit-type from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/ship-and-visit-type"
timestamp: ""
...
# ONS code list: ship-and-visit-type contract

Machine-readable or service-description contract inferred for ONS code list: ship-and-visit-type from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/ship-and-visit-type
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/ship-and-visit-type
