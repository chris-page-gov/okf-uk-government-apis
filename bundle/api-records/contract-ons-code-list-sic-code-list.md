---
type: "Contract"
title: "ONS code list: sic contract"
description: "Machine-readable or service-description contract inferred for ONS code list: sic from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/sic"
timestamp: ""
...
# ONS code list: sic contract

Machine-readable or service-description contract inferred for ONS code list: sic from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/sic
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/sic
