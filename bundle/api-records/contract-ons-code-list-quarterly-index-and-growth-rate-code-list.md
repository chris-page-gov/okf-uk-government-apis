---
type: "Contract"
title: "ONS code list: quarterly-index-and-growth-rate contract"
description: "Machine-readable or service-description contract inferred for ONS code list: quarterly-index-and-growth-rate from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/quarterly-index-and-growth-rate"
timestamp: ""
...
# ONS code list: quarterly-index-and-growth-rate contract

Machine-readable or service-description contract inferred for ONS code list: quarterly-index-and-growth-rate from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/quarterly-index-and-growth-rate
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/quarterly-index-and-growth-rate
