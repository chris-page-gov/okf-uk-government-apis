...
resource: "https://api.os.uk/features/v1/wfs/archive"
timestamp: ""
...
The endpoint to access the Product Archive through the Web Feature Service OS Features API.
...
- Endpoint: https://api.os.uk/features/v1/wfs/archive
