---
type: "Contract"
title: "ONS code list: mmm contract"
description: "Machine-readable or service-description contract inferred for ONS code list: mmm from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/mmm"
timestamp: ""
...
# ONS code list: mmm contract

Machine-readable or service-description contract inferred for ONS code list: mmm from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/mmm
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/mmm
