---
type: "Schema"
title: "ONS code list: single-year-of-age"
description: "Code list exposed by the ONS Beta API: single-year-of-age."
...
# ONS code list: single-year-of-age

Code list exposed by the ONS Beta API: single-year-of-age.
