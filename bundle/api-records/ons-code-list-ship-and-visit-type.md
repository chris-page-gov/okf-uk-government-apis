---
type: "Schema"
title: "ONS code list: ship-and-visit-type"
description: "Code list exposed by the ONS Beta API: ship-and-visit-type."
...
# ONS code list: ship-and-visit-type

Code list exposed by the ONS Beta API: ship-and-visit-type.
