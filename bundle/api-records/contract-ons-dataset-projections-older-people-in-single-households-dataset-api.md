...
# Local authority ageing statistics, household projections for older people contract

Machine-readable or service-description contract inferred for Local authority ageing statistics, household projections for older people from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/datasets/projections-older-people-in-single-households
- Documentation: https://api.beta.ons.gov.uk/v1/datasets/projections-older-people-in-single-households
