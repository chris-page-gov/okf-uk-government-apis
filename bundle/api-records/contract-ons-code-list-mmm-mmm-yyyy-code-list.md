---
type: "Contract"
title: "ONS code list: mmm-mmm-yyyy contract"
description: "Machine-readable or service-description contract inferred for ONS code list: mmm-mmm-yyyy from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/mmm-mmm-yyyy"
timestamp: ""
...
# ONS code list: mmm-mmm-yyyy contract

Machine-readable or service-description contract inferred for ONS code list: mmm-mmm-yyyy from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/mmm-mmm-yyyy
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/mmm-mmm-yyyy
