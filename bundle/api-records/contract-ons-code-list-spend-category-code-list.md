---
type: "Contract"
title: "ONS code list: spend-category contract"
description: "Machine-readable or service-description contract inferred for ONS code list: spend-category from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/spend-category"
timestamp: ""
...
# ONS code list: spend-category contract

Machine-readable or service-description contract inferred for ONS code list: spend-category from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/spend-category
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/spend-category
