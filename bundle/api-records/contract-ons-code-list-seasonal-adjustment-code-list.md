---
type: "Contract"
title: "ONS code list: seasonal-adjustment contract"
description: "Machine-readable or service-description contract inferred for ONS code list: seasonal-adjustment from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/seasonal-adjustment"
timestamp: ""
...
# ONS code list: seasonal-adjustment contract

Machine-readable or service-description contract inferred for ONS code list: seasonal-adjustment from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/seasonal-adjustment
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/seasonal-adjustment
