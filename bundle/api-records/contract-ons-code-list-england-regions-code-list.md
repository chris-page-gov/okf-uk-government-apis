---
type: "Contract"
title: "ONS code list: england-regions contract"
description: "Machine-readable or service-description contract inferred for ONS code list: england-regions from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/england-regions"
timestamp: ""
...
# ONS code list: england-regions contract

Machine-readable or service-description contract inferred for ONS code list: england-regions from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/england-regions
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/england-regions
