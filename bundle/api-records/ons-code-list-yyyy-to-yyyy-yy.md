---
type: "Schema"
title: "ONS code list: yyyy-to-yyyy-yy"
description: "Code list exposed by the ONS Beta API: yyyy-to-yyyy-yy."
...
# ONS code list: yyyy-to-yyyy-yy

Code list exposed by the ONS Beta API: yyyy-to-yyyy-yy.
