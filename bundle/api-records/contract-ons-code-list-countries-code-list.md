---
type: "Contract"
title: "ONS code list: countries contract"
description: "Machine-readable or service-description contract inferred for ONS code list: countries from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/countries"
timestamp: ""
...
# ONS code list: countries contract

Machine-readable or service-description contract inferred for ONS code list: countries from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/countries
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/countries
