---
type: "Schema"
title: "ONS code list: shipping-port"
description: "Code list exposed by the ONS Beta API: shipping-port."
...
# ONS code list: shipping-port

Code list exposed by the ONS Beta API: shipping-port.
