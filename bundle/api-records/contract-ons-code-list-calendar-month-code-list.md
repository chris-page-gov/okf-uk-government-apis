---
type: "Contract"
title: "ONS code list: calendar-month contract"
description: "Machine-readable or service-description contract inferred for ONS code list: calendar-month from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/calendar-month"
timestamp: ""
...
# ONS code list: calendar-month contract

Machine-readable or service-description contract inferred for ONS code list: calendar-month from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/calendar-month
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/calendar-month
