...
resource: "https://api.os.uk/search/links/v1/identifiers/{id}"
timestamp: ""
...
# Linked Identifier Lookup Operation

Replace {id} with an identifier to Look up that identifier and find its associated identifiers, returns a list.
...
- Endpoint: https://api.os.uk/search/links/v1/identifiers/{id}
