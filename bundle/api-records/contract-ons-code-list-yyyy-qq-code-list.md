---
type: "Contract"
title: "ONS code list: yyyy-qq contract"
description: "Machine-readable or service-description contract inferred for ONS code list: yyyy-qq from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/yyyy-qq"
timestamp: ""
...
# ONS code list: yyyy-qq contract

Machine-readable or service-description contract inferred for ONS code list: yyyy-qq from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-qq
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/yyyy-qq
