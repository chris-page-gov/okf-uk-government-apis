---
type: "Schema"
title: "ONS code list: traffic-camera-area"
description: "Code list exposed by the ONS Beta API: traffic-camera-area."
...
# ONS code list: traffic-camera-area

Code list exposed by the ONS Beta API: traffic-camera-area.
