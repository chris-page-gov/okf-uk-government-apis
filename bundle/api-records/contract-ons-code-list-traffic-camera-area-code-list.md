---
type: "Contract"
title: "ONS code list: traffic-camera-area contract"
description: "Machine-readable or service-description contract inferred for ONS code list: traffic-camera-area from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/traffic-camera-area"
timestamp: ""
...
# ONS code list: traffic-camera-area contract

Machine-readable or service-description contract inferred for ONS code list: traffic-camera-area from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/traffic-camera-area
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/traffic-camera-area
