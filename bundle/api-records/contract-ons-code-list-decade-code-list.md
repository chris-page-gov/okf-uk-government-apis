---
type: "Contract"
title: "ONS code list: decade contract"
description: "Machine-readable or service-description contract inferred for ONS code list: decade from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/decade"
timestamp: ""
...
# ONS code list: decade contract

Machine-readable or service-description contract inferred for ONS code list: decade from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/decade
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/decade
