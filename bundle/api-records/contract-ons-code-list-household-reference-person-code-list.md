---
type: "Contract"
title: "ONS code list: household-reference-person contract"
description: "Machine-readable or service-description contract inferred for ONS code list: household-reference-person from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/household-reference-person"
timestamp: ""
...
# ONS code list: household-reference-person contract

Machine-readable or service-description contract inferred for ONS code list: household-reference-person from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/household-reference-person
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/household-reference-person
