---
type: "Schema"
title: "ONS code list: two-year-intervals"
description: "Code list exposed by the ONS Beta API: two-year-intervals."
...
# ONS code list: two-year-intervals

Code list exposed by the ONS Beta API: two-year-intervals.
