---
type: "Contract"
title: "ONS code list: calendar-years contract"
description: "Machine-readable or service-description contract inferred for ONS code list: calendar-years from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/calendar-years"
timestamp: ""
...
# ONS code list: calendar-years contract

Machine-readable or service-description contract inferred for ONS code list: calendar-years from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/calendar-years
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/calendar-years
