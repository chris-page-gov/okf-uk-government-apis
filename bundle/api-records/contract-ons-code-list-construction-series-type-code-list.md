---
type: "Contract"
title: "ONS code list: construction-series-type contract"
description: "Machine-readable or service-description contract inferred for ONS code list: construction-series-type from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/construction-series-type"
timestamp: ""
...
# ONS code list: construction-series-type contract

Machine-readable or service-description contract inferred for ONS code list: construction-series-type from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/construction-series-type
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/construction-series-type
