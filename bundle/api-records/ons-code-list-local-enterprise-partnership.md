---
type: "Schema"
title: "ONS code list: local-enterprise-partnership"
description: "Code list exposed by the ONS Beta API: local-enterprise-partnership."
...
# ONS code list: local-enterprise-partnership

Code list exposed by the ONS Beta API: local-enterprise-partnership.
