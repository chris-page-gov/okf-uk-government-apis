---
type: "Schema"
title: "ONS code list: value-deflation"
description: "Code list exposed by the ONS Beta API: value-deflation."
...
# ONS code list: value-deflation

Code list exposed by the ONS Beta API: value-deflation.
