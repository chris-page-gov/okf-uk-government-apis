---
type: "Contract"
title: "ONS code list: enterprise-regions contract"
description: "Machine-readable or service-description contract inferred for ONS code list: enterprise-regions from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/enterprise-regions"
timestamp: ""
...
# ONS code list: enterprise-regions contract

Machine-readable or service-description contract inferred for ONS code list: enterprise-regions from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/enterprise-regions
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/enterprise-regions
