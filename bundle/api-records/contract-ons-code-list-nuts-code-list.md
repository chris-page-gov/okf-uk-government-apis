---
type: "Contract"
title: "ONS code list: nuts contract"
description: "Machine-readable or service-description contract inferred for ONS code list: nuts from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/nuts"
timestamp: ""
...
# ONS code list: nuts contract

Machine-readable or service-description contract inferred for ONS code list: nuts from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/nuts
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/nuts
