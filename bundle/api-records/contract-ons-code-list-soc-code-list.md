---
type: "Contract"
title: "ONS code list: soc contract"
description: "Machine-readable or service-description contract inferred for ONS code list: soc from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/soc"
timestamp: ""
...
# ONS code list: soc contract

Machine-readable or service-description contract inferred for ONS code list: soc from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/soc
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/soc
