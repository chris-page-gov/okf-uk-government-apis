---
type: "Contract"
title: "ONS code list: countries-and-territories contract"
description: "Machine-readable or service-description contract inferred for ONS code list: countries-and-territories from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/countries-and-territories"
timestamp: ""
...
# ONS code list: countries-and-territories contract

Machine-readable or service-description contract inferred for ONS code list: countries-and-territories from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/countries-and-territories
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/countries-and-territories
