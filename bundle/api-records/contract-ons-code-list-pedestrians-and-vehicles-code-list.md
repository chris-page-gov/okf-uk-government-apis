---
type: "Contract"
title: "ONS code list: pedestrians-and-vehicles contract"
description: "Machine-readable or service-description contract inferred for ONS code list: pedestrians-and-vehicles from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/pedestrians-and-vehicles"
timestamp: ""
...
# ONS code list: pedestrians-and-vehicles contract

Machine-readable or service-description contract inferred for ONS code list: pedestrians-and-vehicles from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/pedestrians-and-vehicles
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/pedestrians-and-vehicles
