---
type: "Contract"
title: "ONS code list: local-enterprise-partnership contract"
description: "Machine-readable or service-description contract inferred for ONS code list: local-enterprise-partnership from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/local-enterprise-partnership"
timestamp: ""
...
# ONS code list: local-enterprise-partnership contract

Machine-readable or service-description contract inferred for ONS code list: local-enterprise-partnership from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/local-enterprise-partnership
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/local-enterprise-partnership
