---
type: "Contract"
title: "ONS code list: yyyy contract"
description: "Machine-readable or service-description contract inferred for ONS code list: yyyy from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/yyyy"
timestamp: ""
...
# ONS code list: yyyy contract

Machine-readable or service-description contract inferred for ONS code list: yyyy from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/yyyy
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/yyyy
