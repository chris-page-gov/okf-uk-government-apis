---
type: "Contract"
title: "ONS code list: sic-unofficial contract"
description: "Machine-readable or service-description contract inferred for ONS code list: sic-unofficial from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/sic-unofficial"
timestamp: ""
...
# ONS code list: sic-unofficial contract

Machine-readable or service-description contract inferred for ONS code list: sic-unofficial from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/sic-unofficial
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/sic-unofficial
