---
type: "Contract"
title: "ONS code list: sexual-orientation contract"
description: "Machine-readable or service-description contract inferred for ONS code list: sexual-orientation from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/sexual-orientation"
timestamp: ""
...
# ONS code list: sexual-orientation contract

Machine-readable or service-description contract inferred for ONS code list: sexual-orientation from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/sexual-orientation
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/sexual-orientation
