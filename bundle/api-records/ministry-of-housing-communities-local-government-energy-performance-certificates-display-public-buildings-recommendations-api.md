---
type: "API Product"
title: "Energy Performance Certificates - Display (public buildings) Recommendations API"
...
resource: "https://epc.opendatacommunities.org/api/v1/display/recommendations/:lmk-key"
...
# Energy Performance Certificates - Display (public buildings) Recommendations API
...
- Endpoint: https://epc.opendatacommunities.org/api/v1/display/recommendations/:lmk-key
- Documentation: https://epc.opendatacommunities.org/docs/api/display#display-recommendations
