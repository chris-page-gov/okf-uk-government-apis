---
type: "Schema"
title: "ONS code list: age-groups"
description: "Code list exposed by the ONS Beta API: age-groups."
...
# ONS code list: age-groups

Code list exposed by the ONS Beta API: age-groups.
