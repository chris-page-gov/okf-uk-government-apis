---
type: "Contract"
title: "ONS code list: tax-benefit-type contract"
description: "Machine-readable or service-description contract inferred for ONS code list: tax-benefit-type from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/tax-benefit-type"
timestamp: ""
...
# ONS code list: tax-benefit-type contract

Machine-readable or service-description contract inferred for ONS code list: tax-benefit-type from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/tax-benefit-type
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/tax-benefit-type
