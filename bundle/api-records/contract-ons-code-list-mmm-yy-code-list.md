---
type: "Contract"
title: "ONS code list: mmm-yy contract"
description: "Machine-readable or service-description contract inferred for ONS code list: mmm-yy from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/mmm-yy"
timestamp: ""
...
# ONS code list: mmm-yy contract

Machine-readable or service-description contract inferred for ONS code list: mmm-yy from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/mmm-yy
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/mmm-yy
