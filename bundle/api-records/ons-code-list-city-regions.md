---
type: "Schema"
title: "ONS code list: city-regions"
description: "Code list exposed by the ONS Beta API: city-regions."
...
# ONS code list: city-regions

Code list exposed by the ONS Beta API: city-regions.
