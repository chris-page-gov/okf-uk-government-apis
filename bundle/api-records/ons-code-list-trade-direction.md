---
type: "Schema"
title: "ONS code list: trade-direction"
description: "Code list exposed by the ONS Beta API: trade-direction."
...
# ONS code list: trade-direction

Code list exposed by the ONS Beta API: trade-direction.
