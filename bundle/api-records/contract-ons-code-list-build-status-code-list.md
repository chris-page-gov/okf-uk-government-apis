---
type: "Contract"
title: "ONS code list: build-status contract"
description: "Machine-readable or service-description contract inferred for ONS code list: build-status from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/build-status"
timestamp: ""
...
# ONS code list: build-status contract

Machine-readable or service-description contract inferred for ONS code list: build-status from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/build-status
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/build-status
