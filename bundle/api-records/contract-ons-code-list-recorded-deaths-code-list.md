---
type: "Contract"
title: "ONS code list: recorded-deaths contract"
description: "Machine-readable or service-description contract inferred for ONS code list: recorded-deaths from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/recorded-deaths"
timestamp: ""
...
# ONS code list: recorded-deaths contract

Machine-readable or service-description contract inferred for ONS code list: recorded-deaths from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/recorded-deaths
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/recorded-deaths
