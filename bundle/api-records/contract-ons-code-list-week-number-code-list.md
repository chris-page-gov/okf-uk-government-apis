---
type: "Contract"
title: "ONS code list: week-number contract"
description: "Machine-readable or service-description contract inferred for ONS code list: week-number from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/week-number"
timestamp: ""
...
# ONS code list: week-number contract

Machine-readable or service-description contract inferred for ONS code list: week-number from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/week-number
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/week-number
