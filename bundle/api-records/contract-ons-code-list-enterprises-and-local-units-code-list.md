---
type: "Contract"
title: "ONS code list: enterprises-and-local-units contract"
description: "Machine-readable or service-description contract inferred for ONS code list: enterprises-and-local-units from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/enterprises-and-local-units"
timestamp: ""
...
# ONS code list: enterprises-and-local-units contract

Machine-readable or service-description contract inferred for ONS code list: enterprises-and-local-units from public metadata.
...
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/enterprises-and-local-units
