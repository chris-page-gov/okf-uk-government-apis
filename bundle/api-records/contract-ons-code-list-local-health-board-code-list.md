---
type: "Contract"
title: "ONS code list: local-health-board contract"
description: "Machine-readable or service-description contract inferred for ONS code list: local-health-board from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/local-health-board"
timestamp: ""
...
# ONS code list: local-health-board contract

Machine-readable or service-description contract inferred for ONS code list: local-health-board from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/local-health-board
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/local-health-board
