---
type: "Contract"
title: "ONS code list: economic-activity contract"
description: "Machine-readable or service-description contract inferred for ONS code list: economic-activity from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/economic-activity"
timestamp: ""
...
# ONS code list: economic-activity contract

Machine-readable or service-description contract inferred for ONS code list: economic-activity from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/economic-activity
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/economic-activity
