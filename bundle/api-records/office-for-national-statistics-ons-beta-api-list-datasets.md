---
type: "API Operation"
title: "ONS Beta API: List datasets"
description: "Template operation for the ONS Beta API: List datasets."
...
# ONS Beta API: List datasets

Template operation for the ONS Beta API: List datasets.
