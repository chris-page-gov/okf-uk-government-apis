---
type: "Contract"
title: "ONS code list: healthcare-financing-scheme contract"
description: "Machine-readable or service-description contract inferred for ONS code list: healthcare-financing-scheme from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/healthcare-financing-scheme"
timestamp: ""
...
# ONS code list: healthcare-financing-scheme contract

Machine-readable or service-description contract inferred for ONS code list: healthcare-financing-scheme from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/healthcare-financing-scheme
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/healthcare-financing-scheme
