---
type: "Contract"
title: "ONS code list: value-deflation contract"
description: "Machine-readable or service-description contract inferred for ONS code list: value-deflation from public metadata."
resource: "https://api.beta.ons.gov.uk/v1/code-lists/value-deflation"
timestamp: ""
...
# ONS code list: value-deflation contract

Machine-readable or service-description contract inferred for ONS code list: value-deflation from public metadata.
...
- Endpoint: https://api.beta.ons.gov.uk/v1/code-lists/value-deflation
- Documentation: https://api.beta.ons.gov.uk/v1/code-lists/value-deflation
